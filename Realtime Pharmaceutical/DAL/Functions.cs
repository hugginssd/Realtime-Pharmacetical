...
namespace Realtime_Pharmaceutical.DAL
{
    ...
    public static class ConsoleHelper
    {
        ...
        public static void ShowDataViewInConsole(Context mlContext, DataView dataView, int numberOfRows = 4)
        {
        ...
        public static void PeekDataViewInConsole(Context mlContext, DataView dataView, IEstimator<ITransformer> pipeline, int numberOfRows = 4)
        {
        ...
        public static List<float[]> PeekVectorColumnDataInConsole(Context mlContext, string columnName, DataView dataView, IEstimator<ITransformer> pipeline, int numberOfRows = 4)
        {
        ...
        internal static void PrintIterationException(object exception)
        {
            throw new NotImplementedException();
        }

        internal static void PrintIterationMetrics(int iterationIndex, object trainerName, object validationMetrics, object runtimeInSeconds)
        {
            throw new NotImplementedException();
        }
